...
# f=open("Pubkey1024.pubkey", "wb")
# f.write(pubKeyPEM1024)
# f.close()
...
# f=open("Privkey1024.privkey", "wb")
# f.write(privKeyPEM1024)
# f.close()
...
# f=open("Pubkey2048.pubkey", "wb")
# f.write(pubKeyPEM2048)
# f.close()
...
# f=open("Privkey2048.privkey", "wb")
# f.write(privKeyPEM2048)
# f.close()
...
# f=open("Pubkey3072.pubkey", "wb")
# f.write(pubKeyPEM3072)
# f.close()
...
# f=open("Privkey3072.privkey", "wb")
# f.write(privKeyPEM3072)
# f.close()
